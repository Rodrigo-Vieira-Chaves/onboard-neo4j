...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { FriendshipController } from './../routes/create-friendship/friendship-controller';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { HelloWorldController } from './../routes/helloWorld/hello-world-controller';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.post('/friendship',
            ...
            ...(fetchMiddlewares<RequestHandler>(FriendshipController.prototype.createFriendship)),
            ...
            try {
              ...
              const promise = controller.createFriendship.apply(controller, validatedArgs as any);
        ...
        app.get('/helloworld',
            ...
            function HelloWorldController_getHelloWorld(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.post('/helloworld',
            ...(fetchMiddlewares<RequestHandler>(HelloWorldController)),
            ...(fetchMiddlewares<RequestHandler>(HelloWorldController.prototype.showAction)),

            function HelloWorldController_showAction(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.showAction.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/user',
            ...
            const args = {
                    userCreation: {"in":"body","name":"userCreation","required":true,"ref":"UserCreation"},
            };
